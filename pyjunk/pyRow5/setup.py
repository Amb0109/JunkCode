...
class BuildExe:
    def __init__(self):
        ...
        # 游戏作者
        self.author_name = "amb"
        # 联系电邮
        self.author_email = "amb.main@gmail.com"
        # 游戏版权
        self.copyright = "Copyright (c) 2011 amb."
        # 游戏描述
        self.project_description = "a simple game"
        # 游戏图标(None的话使用pygame的默认图标)
        self.icon_file = None
        # 额外需要拷贝的文件、文件夹(图片，音频等)
        self.extra_datas = ['PLAYBILL.TTF']
        # 额外需要的python库名
        self.extra_modules = []
        # 需要排除的python库
        self.exclude_modules = []
        # 额外需要排除的dll
        self.exclude_dll = ['Game.py']
        # 需要加入的py文件
        self.extra_scripts = []
